...
def prepare_data(data_path: pathlib.Path = pathlib.Path('./md17'),
                 k: int = 10,
...
def main():
	...
	checkpoint_callback = ModelCheckpoint(
		dirpath='checkpoints',
		filename='md17-mlp-{epoch:02d}-{val_loss:.2f}',
		save_top_k=3,
		monitor='val_loss'
	)
	...
	mean, variance = calculate_mean_and_variance_labels(qm9data.train_dataloader())
